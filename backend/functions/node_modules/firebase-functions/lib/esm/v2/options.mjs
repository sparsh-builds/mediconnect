...
* @internal
*/
const MAX_SCHEDULED_OR_TASK_TIMEOUT_SECONDS = 1800;
/**
...
//#endregion
export { MAX_EVENT_TIMEOUT_SECONDS, MAX_HTTPS_TIMEOUT_SECONDS, MAX_IDENTITY_TIMEOUT_SECONDS, MAX_SCHEDULED_OR_TASK_TIMEOUT_SECONDS, RESET_VALUE, __getSpec, assertTimeoutSecondsValid, getGlobalOptions, optionsToEndpoint, optionsToTriggerAnnotations, requiresRole, setGlobalOptions };