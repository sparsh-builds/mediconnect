...
function onTaskDispatched(optsOrHandler, handler) {
	...
	Object.defineProperty(func, "__trigger", { get: () => {
		...
		const specificOpts$1 = require_v2_options.optionsToTriggerAnnotations(opts, "scheduledOrTask");
	...
	const specificOpts = require_v2_options.optionsToEndpoint(opts, "scheduledOrTask");
	func.__endpoint = {
		platform: "gcfv2",
